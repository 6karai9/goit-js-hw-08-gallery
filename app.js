...
function onCloseLightbox() {
  lightboxImageEl.removeEventListener(
    'mousemove',
    _.throttle(onMouseMove, 500),
  );
...
function lightboxImageRight() {
  const currentImgElIndex = galleryItems.indexOf(
    galleryItems.find(item => item.original === lightboxImageEl.src),
  );
